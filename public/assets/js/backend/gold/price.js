define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'gold/price/index' + location.search,
                    add_url: 'gold/price/add',
                    edit_url: 'gold/price/edit',
                    del_url: 'gold/price/del',
                    multi_url: 'gold/price/multi',
                    import_url: 'gold/price/import',
                    table: 'gold_price',
                }
            });
